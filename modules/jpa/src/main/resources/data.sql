...
VALUES (1, 0, 'Alpha Bag', 15000, 100, '2024-12-15 14:32:10', now()),
       ...
       (1, 0, 'Gamma Watch', 8500, 0, '2025-01-03 16:47:22', now()),
       (1, 0, 'Delta Jacket', 45000, 30, '2024-10-12 11:28:45', now()),
       (1, 0, 'Echo Hat', 12000, 0, '2024-12-31 08:12:17', now()),
...
INSERT INTO heartCount (user_id, target_id, target_type, created_at, updated_at)
VALUES
