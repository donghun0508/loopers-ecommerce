...
class UserServiceTest {
    ...
    void createMember() {
        ...
        var member = userService.create(command);

        assertThat(member.getAccountId()).isNotNull();
    ...
    void findByAccountId() {
        ...
        var foundMember = userService.findByAccountId(member.getAccountId());
        assertThat(foundMember).isNotNull();
        assertThat(foundMember.getId()).isEqualTo(member.getId());
        assertThat(foundMember.getAccountId()).isEqualTo(member.getAccountId());
    }
}
